# Fannie Mae Underwriting Taxonomy

Full domain → subtopic map. Each leaf links to its topic page (created as needed, not all up front).
Pages not yet created appear as plain text. Created pages appear as wikilinks.
